...
console.log('This script populates some test books, authors, genres and bookinstances to the database. Specified database as argument - populatedb mongodb+srv://userDb:1234@cluster0.a9azn.mongodb.net/local_library?retryWrites=true');
...
// mongoose.connection.collections['bookinstances'].drop(function(err) {
//   console.log('collection authors dropped')
// })
